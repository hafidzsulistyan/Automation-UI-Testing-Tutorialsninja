...
class RegisterPage(BasePage):
    ...
    def verify_all_warnings(
        ...
        if (
            expected_privacy_policy_warning.__contains__(actual_privacy_policy_warning)
            and expected_first_name_warning_message.__eq__(actual_first_name_warning_message)
            and expected_last_name_warning_message.__eq__(actual_last_name_warning_message)
            and expected_email_warning_message.__eq__(actual_email_warning_message)
            and expected_telephone_warning_message.__eq__(actual_telephone_warning_message)
            and expected_password_warning_message.__eq__(actual_password_warning_message)
        ):
            status = True
